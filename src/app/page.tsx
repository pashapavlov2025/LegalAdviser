...
export default function DashboardPage() {
  ...
  return (
    <>
      <h2 className="text-2xl font-bold">Проблемы из 1С</h2>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          ...
          <div key={s.l} className="bg-white border border-gray-200 rounded-lg p-4 text-center">
            <div className="text-3xl font-bold text-[#1a365d]">{s.n}</div>
